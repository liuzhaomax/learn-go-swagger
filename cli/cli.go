...
func makeClient(cmd *cobra.Command, args []string) (*client.PetService, error) {
...
func MakeRootCmd() (*cobra.Command, error) {
	...
	operationGroupPetCmd, err := makeOperationGroupPetCmd()
	if err != nil {
		return nil, err
	}
	rootCmd.AddCommand(operationGroupPetCmd)
...
func makeOperationGroupPetCmd() (*cobra.Command, error) {
	operationGroupPetCmd := &cobra.Command{
		Use:  "pet",
		Long: ``,
	}

	operationGetPetCmd, err := makeOperationPetGetPetCmd()
	if err != nil {
		return nil, err
	}
	operationGroupPetCmd.AddCommand(operationGetPetCmd)

	return operationGroupPetCmd, nil
}
